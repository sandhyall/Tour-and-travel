...
useEffect(() => {
  ...
  const addDateRow = () =>
    setAvailableDates((prev) => [...prev, { date: "", totalSeats: "", price: "", status: "available" }]);
...
const removeMapImage = () => {
  ...
  const resetForm = () => {
    setForm({
      title: "", country: "Nepal", duration: "", price: "", oldPrice: "",
      overview: "", difficulty: "", activity: "", maxAltitude: "", bestSeason: "",
      startPoint: "", endPoint: "", meals: "", accommodation: "",
      categoryType: "standard", badge: false, isBestSeller2026: false,
      isLuxuryVIP: false, isPeakClimbing: false, isShortTrek: false,
      isBhutanTour: false, isTibetTour: false,
      
      guideName: "", guideBio: "", guideExperience: "", guideLanguages: "",
    });
    setFeaturedImage(null);
    setGallery([]);
  ...
  if (value !== undefined && value !== null && value !== "") {
    ...
    const filteredDates = availableDates.filter((d) => d.date !== "" && d.totalSeats !== "");
    ...
    <div className="flex bg-[#f8fafc] min-h-screen font-sans antialiased text-slate-900">
      ...
      <main className="flex-1 lg:ml-64 p-4 sm:p-6 lg:p-8 xl:p-12 min-w-0">
        <div className="max-w-5xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-10 lg:space-y-12" encType="multipart/form-data">
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <h2 className="text-lg sm:text-xl font-black mb-5 sm:mb-8 ml-2">🖼️ Media Gallery</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
                ...
                <div className="md:col-span-1 space-y-2">
                  ...
                  <div className="relative border-2 border-dashed border-slate-200 hover:border-indigo-500 rounded-2xl h-48 sm:h-64 flex flex-col items-center justify-center bg-slate-50 overflow-hidden group transition-all">
                    {featuredImage ? (
                      <>
                        <img src={featuredImage.preview} alt="Featured" className="w-full h-full object-cover" />
                      ...
                      <label className="cursor-pointer flex flex-col items-center justify-center w-full h-full p-4 text-center">
                        <FaCloudUploadAlt className="text-slate-400 group-hover:text-indigo-500 mb-2 transition-colors" size={28} />
                  ...
                  <div className="border-2 border-dashed border-slate-200 hover:border-indigo-500 rounded-2xl p-4 sm:p-6 min-h-48 sm:min-h-64 flex flex-col bg-slate-50 transition-all">
                    <div className="grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-4 mb-4">
                      {gallery.map((img, index) => (
                        <div key={index} className="relative aspect-video rounded-xl overflow-hidden group border border-slate-200 shadow-sm">
                    ...
                    {gallery.length === 0 && (
                      <div className="flex-1 flex flex-col items-center justify-center text-center my-auto py-4">
                        <p className="text-sm font-medium text-slate-400">No gallery images uploaded yet</p>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <h2 className="text-lg sm:text-xl font-black mb-5 sm:mb-8 ml-2">📍 Primary Information</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4 sm:gap-6">
                <div className="sm:col-span-2 md:col-span-4">
                  ...
                  <input name="title" value={form.title} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Annapurna Circuit Trek" required />
                </div>
                <div className="sm:col-span-2 md:col-span-2">
                  <label className={labelStyle}>Region / Country</label>
                  <select name="country" value={form.country} onChange={handleInputChange} className={inputStyle}>
                ...
                <div className="sm:col-span-1 md:col-span-2">
                  ...
                  <input type="number" name="duration" value={form.duration} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., 14" />
                </div>
                <div className="sm:col-span-1 md:col-span-2">
                  <label className={labelStyle}>Current Price ($)</label>
                  <input type="number" name="price" value={form.price} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., 1200" />
                </div>
                <div className="sm:col-span-2 md:col-span-2">
                  <label className={labelStyle}>Old Price ($)</label>
                  <input type="number" name="oldPrice" value={form.oldPrice} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., 1500" />
                </div>
                <div className="sm:col-span-2 md:col-span-6">
                  <label className={labelStyle}>Marketing Overview</label>
                  <textarea name="overview" value={form.overview} onChange={handleInputChange}
                    rows="3" className={inputStyle} placeholder="Compelling summary..." />
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                <div>
                  ...
                  <select name="categoryType" value={form.categoryType} onChange={handleInputChange} className={inputStyle}>
                ...
                <div className="sm:col-span-1 md:col-span-2 flex items-end">
                  <label className="w-full flex items-center gap-3 p-3 sm:p-4 border border-slate-100 bg-slate-50/50 rounded-2xl cursor-pointer hover:bg-slate-50 transition-all select-none">
                    <input type="checkbox" name="badge" checked={form.badge} onChange={handleInputChange}
                      className="w-5 h-5 rounded-lg text-indigo-600 focus:ring-indigo-500 border-slate-300 shrink-0" />
                    <div>
                      <span className="block text-sm font-bold text-slate-700">Mark as Popular Trek (Homepage Default)</span>
                    </div>
                  </label>
                </div>
              </div>
                  ...
                  <>
                    {[
                      ...
                      <label key={name}
                        ...
                        <input type="checkbox" name={name} checked={form[name]} onChange={handleInputChange}
                          className="w-5 h-5 rounded-lg text-indigo-600 focus:ring-indigo-500 border-slate-300 shrink-0" />
                        <div>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <div className="space-y-3 sm:space-y-4">
                {availableDates.map((item, index) => (
                  <div key={index} className="bg-slate-50 p-3 sm:p-4 rounded-2xl border border-slate-100">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <input type="number" placeholder="e.g., 15" value={item.totalSeats}
                      ...
                      <div>
                        ...
                        <input type="number" placeholder="Optional" value={item.price}
                      ...
                      <div className="flex items-end gap-2">
                        <div className="flex-1">
                          ...
                          <select value={item.status} onChange={(e) => handleDateChange(index, "status", e.target.value)}
                            className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:border-cyan-500 text-slate-700 font-medium text-sm transition-all">
                        ...
                        {availableDates.length > 1 && (
                          <button type="button" onClick={() => removeDateRow(index)}
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <h2 className="text-lg sm:text-xl font-black mb-5 sm:mb-8 ml-2">⚙️ Technical Details</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                <div>
                  <label className={labelStyle}>Difficulty Level</label>
                  <select name="difficulty" value={form.difficulty} onChange={handleInputChange} className={inputStyle}>
                ...
                <div>
                  ...
                  <input name="activity" value={form.activity} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Trekking" />
                </div>
                <div>
                  <label className={labelStyle}>Max Altitude</label>
                  <input name="maxAltitude" value={form.maxAltitude} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., 5,416m" />
                </div>
                <div>
                  <label className={labelStyle}>Best Season</label>
                  <input name="bestSeason" value={form.bestSeason} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Mar-May" />
                </div>
                <div>
                  <label className={labelStyle}>Start Point</label>
                  <input name="startPoint" value={form.startPoint} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Kathmandu" />
                </div>
                <div>
                  <label className={labelStyle}>End Point</label>
                  <input name="endPoint" value={form.endPoint} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Pokhara" />
                </div>
                <div>
                  <label className={labelStyle}>Meals Provided</label>
                  <input name="meals" value={form.meals} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., B/L/D" />
                </div>
                <div className="sm:col-span-2">
                  <label className={labelStyle}>Accommodation</label>
                  <input name="accommodation" value={form.accommodation} onChange={handleInputChange}
                    className={inputStyle} placeholder="e.g., Teahouse" />
                </div>
              </div>
            </section>
...
<section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
  ...
  <p className="text-sm text-slate-500 mb-6 ml-2">
    Upload a trek route map image. Users can view and download it from the trip page.
  </p>
          ...
          />
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <p className="text-xs sm:text-sm text-slate-500 mb-5 sm:mb-6 ml-2">
                Upload PDF files that travellers can download from the trip detail page.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="p-4 sm:p-5 border-2 border-dashed border-slate-200 hover:border-rose-400 rounded-2xl bg-slate-50 transition-all space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-700">Trip Brochure</p>
                      <p className="text-[11px] text-slate-400">Full overview, highlights & inclusions</p>
                    </div>
                  </div>
                  {brochureFile ? (
                    <div className="flex items-center justify-between bg-rose-50 border border-rose-200 rounded-xl px-3 py-2.5">
                      <div className="flex items-center gap-2 min-w-0">
                        <FaFilePdf size={12} className="text-rose-500 shrink-0" />
                        <span className="text-xs font-semibold text-rose-700 truncate">{brochureFile.name}</span>
                      </div>
                    ...
                    <label className="cursor-pointer block w-full text-center py-2.5 rounded-xl bg-white border border-slate-200 hover:border-rose-400 hover:bg-rose-50 transition-all">
                      <span className="text-xs font-bold text-slate-600">Choose PDF File</span>
                      <input type="file" accept=".pdf" onChange={(e) => setBrochureFile(e.target.files[0])} className="hidden" />
                    </label>
                  )}
                </div>
                ...
                <div className="p-4 sm:p-5 border-2 border-dashed border-slate-200 hover:border-blue-400 rounded-2xl bg-slate-50 transition-all space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-700">Detailed Itinerary PDF</p>
                      <p className="text-[11px] text-slate-400">Day-by-day schedule with logistics</p>
                    </div>
                  </div>
                  {itineraryPdfFile ? (
                    <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-xl px-3 py-2.5">
                      <div className="flex items-center gap-2 min-w-0">
                        <FaFilePdf size={12} className="text-blue-500 shrink-0" />
                        <span className="text-xs font-semibold text-blue-700 truncate">{itineraryPdfFile.name}</span>
                      </div>
                      <button type="button" onClick={() => setItineraryPdfFile(null)}
                    ...
                    <label className="cursor-pointer block w-full text-center py-2.5 rounded-xl bg-white border border-slate-200 hover:border-blue-400 hover:bg-blue-50 transition-all">
                      <span className="text-xs font-bold text-slate-600">Choose PDF File</span>
                      <input type="file" accept=".pdf" onChange={(e) => setItineraryPdfFile(e.target.files[0])} className="hidden" />
                    </label>
                  )}
                </div>
              </div>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10 relative overflow-hidden">
              ...
              <p className="text-xs sm:text-sm text-slate-500 mb-5 sm:mb-6 ml-2">
                Add the expert guide for this expedition. This will be displayed on the trip detail page.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-5 sm:gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative border-2 border-dashed border-slate-200 hover:border-amber-400 rounded-2xl aspect-square flex flex-col items-center justify-center bg-slate-50 overflow-hidden group transition-all max-w-[200px] mx-auto md:mx-0">
                    {guidePhotoPreview ? (
                      <>
                        <img src={guidePhotoPreview} alt="Guide" className="w-full h-full object-cover" />
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center">
                          <button type="button" onClick={removeGuidePhoto}
                      ...
                      <label className="cursor-pointer flex flex-col items-center justify-center w-full h-full p-4 text-center">
                        <FaUserTie className="text-slate-400 group-hover:text-amber-500 mb-2 transition-colors" size={28} />
                        <span className="text-xs font-bold text-slate-600">Upload Photo</span>
                        <input type="file" accept="image/*" onChange={handleGuidePhotoChange} className="hidden" />
                      </label>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                  <div className="sm:col-span-2">
                    ...
                    <input name="guideName" value={form.guideName} onChange={handleInputChange}
                      className={inputStyle} placeholder="e.g., Pemba Sherpa" />
                  </div>
                  <div>
                    <label className={labelStyle}>Experience</label>
                    <input name="guideExperience" value={form.guideExperience} onChange={handleInputChange}
                      className={inputStyle} placeholder="e.g., 15+ Years" />
                  </div>
                  <div>
                    <label className={labelStyle}>Languages Spoken</label>
                    <input name="guideLanguages" value={form.guideLanguages} onChange={handleInputChange}
                      className={inputStyle} placeholder="e.g., Nepali, English, Hindi" />
                  </div>
                  <div className="sm:col-span-2">
                    <label className={labelStyle}>Bio / Description</label>
                    <textarea name="guideBio" value={form.guideBio} onChange={handleInputChange}
                      rows="3" className={inputStyle}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-white p-5 sm:p-6 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 border-t-4 border-t-amber-400">
                <h3 className="font-black text-slate-800 mb-4 text-sm sm:text-base">⭐ Highlights</h3>
              ...
              <div className="bg-white p-5 sm:p-6 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 border-t-4 border-t-green-400">
                <h3 className="font-black text-slate-800 mb-4 text-sm sm:text-base">✅ Includes</h3>
              ...
              <div className="bg-white p-5 sm:p-6 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 border-t-4 border-t-red-400">
                <h3 className="font-black text-slate-800 mb-4 text-sm sm:text-base">❌ Excludes</h3>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10">
              <h2 className="text-lg sm:text-xl font-black mb-4 sm:mb-6">🗺️ Tactical Route Itinerary</h2>
            ...
            <section className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 p-5 sm:p-8 lg:p-10">
              <div className="flex flex-wrap justify-between items-center gap-3 mb-5 sm:mb-6">
                <h2 className="text-lg sm:text-xl font-black">💬 Frequently Asked Questions</h2>
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div key={index} className="p-4 sm:p-5 bg-slate-50 rounded-2xl border border-slate-100 space-y-3 relative group">
                    ...
                    <textarea rows="2" placeholder="Answer..." value={faq.answer}
