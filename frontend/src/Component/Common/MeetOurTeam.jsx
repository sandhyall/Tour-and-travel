...
const smallVariant = (url) => url.replace("w=500&h=650", "w=300&h=390");
    ...
    <div className="bg-[#faf8f3] text-gray-900 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <nav className="text-sm text-gray-500 mb-8">
          <Link to="/" className="hover:text-[#f1b400]">
            Home
          </Link>

          <span className="mx-3 text-gray-300">{">"}</span>

          <span className="text-emerald-500 font-semibold">Meet Our Team</span>
        </nav>
        ...
        <div className="max-w-4xl mb-16">
          ...
          <div className="space-y-7 text-lg leading-9 text-gray-700">
            <p>
              ...
              , our greatest strength is our dedicated and experienced team of
              travel experts, trekking leaders, mountain guides, and adventure
              specialists.
            </p>

            <p>
              Our team members come from different Himalayan regions of Nepal
              and possess deep knowledge of local culture, traditions, trekking
              routes, mountain safety, and responsible tourism practices.
            </p>

            <p>
              Every guide at Wales Trek and Travel is professionally trained,
              government licensed, and experienced in handling trekking
              expeditions, cultural tours, peak climbing, and high-altitude
              adventures.
            </p>

            <p>
              We proudly maintain high standards of customer care,
              communication, and safety. Our multilingual guides speak fluent
              English and several international languages, helping travelers
              feel comfortable and connected throughout their journey.
            </p>

            <p>
              Whether you are trekking to Everest Base Camp, exploring the
              cultural heritage of Kathmandu, or discovering the hidden beauty
              of Bhutan and Tibet, our passionate team is committed to making
              your experience authentic, safe, and unforgettable.
            </p>

            <p className="font-semibold text-black">
              At Wales Trek and Travel, we believe travel is not just about
              reaching destinations — it is about building meaningful
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
            ...
            <h3 className="text-2xl font-bold mb-4">Experienced Guides</h3>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 leading-8">
              We focus on creating safe, memorable, and personalized adventures
              for every traveler.
            </p>
          </div>
        </div>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative overflow-hidden aspect-[4/5]">
                <img
                  src={member.image}
                  srcSet={`${smallVariant(member.image)} 300w, ${member.image} 500w`}
        ...
        <div className="mt-24 bg-[#2c3338] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-300 leading-9 mb-10">
            ...
            the breathtaking mountains, cultures, and hidden wonders of Nepal,
            Bhutan, and Tibet.
          </p>
